...
#include "../../../../src/serialNetTools/mySerial/mySerial.h"
...
QT_MOC_LITERAL(1, 9, 13), // "signal_serial"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "msg"
QT_MOC_LITERAL(4, 28, 9), // "slot_read"
QT_MOC_LITERAL(5, 38, 10), // "slot_write"
QT_MOC_LITERAL(6, 49, 10) // "slot_start"

    },
    "MySerial\0signal_serial\0\0msg\0slot_read\0"
    "slot_write\0slot_start"
};
...
void MySerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_serial((*reinterpret_cast< const QVariantMap(*)>(_a[1]))); break;
        case 1: _t->slot_read(); break;
        case 2: _t->slot_write((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MySerial::*)(const QVariantMap & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySerial::signal_serial)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MySerial::signal_serial(const QVariantMap & _t1)
{
